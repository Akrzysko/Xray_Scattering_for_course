...
class PointOutput(DetectorOutput):
    ...
    def get_header_info(self):
        ...
        # self.meta_data["count_time"] = float(self.cut_out_str(self.original_data_str, "ROI_2_net: ", "LIVE_TIME: "))
    ...
    def get_interest_regions(self):
        self.meta_data["compton_counts"] = float(self.cut_out_str(self.original_data_str, "ROI_0: ", "ROI_0_net: "))
        self.meta_data["elastic_counts"] = float(self.cut_out_str(self.original_data_str, "ROI_1: ", "ROI_1_net: "))
        # self.meta_data["roi_counts"] = float(self.cut_out_str(self.original_data_str, "ROI_2:", "ROI_2_net:"))
        
        self.meta_data["compton_cps"] = self.meta_data["compton_counts"] / self.meta_data["count_time"] 
        self.meta_data["elastic_cps"] = self.meta_data["elastic_counts"] / self.meta_data["count_time"] 
        # self.meta_data["roi_counts"] = self.meta_data["compton_counts"] / self.meta_data["count_time"] 
    ...
    def get_intensity(self):
        ...
        self.meta_data["compton_ratio"] = round(self.meta_data["compton_counts"]/self.meta_data["total_counts"], 2)
